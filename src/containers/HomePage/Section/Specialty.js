...
class Specialty extends Component {
    ...
    handleMoreInfoButtonClick = () => {
        if (this.props.history) {
            this.props.history.push('/specialties'); // Thay đổi '/your-target-page' bằng đường dẫn trang bạn muốn chuyển đến
        }
    };
            ...
            <div className="section-share section-specialty">
                <div className="section-container">
                    <div className="section-header">
                        <span className="title-section">< FormattedMessage id="hompage.specialty-popular" /></span>
