...
const getProfilerDoctorById = (doctorId) => {
...
export {
    ...
    getProfilerDoctorById, postPatientBookAppointment,
    postVerifyBookAppointment, createNewSpecialty,
    getAllSpecialty, getAllDetailSpecialtyById, createNewClinic, getAllClinic,
